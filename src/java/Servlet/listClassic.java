...
public class listClassic extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        sesion.removeAttribute("timeCla");
...
//        String timeClass = request.getParameter("timeClass");
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            sesion.setAttribute("idSubject", subject.getId());
            sesion.setAttribute("nameSubject", subject.getName());
            
            ClassicDAO classicDAO = new ClassicDAO();
            List<Classic> listClassics = new ArrayList<>();
            listClassics = classicDAO.getListClassicByIdSubject(subject.getId());
//            String idClass = classicDAO.getIDClassByName(timeClass, subject.getId());
            ...
            phanTramDiem = phanTramDiemDAO.getPhanTramDiemByIdSubject(subject.getId());
