 ...
 * @author DELL
 */
public class listBangDiemPass extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        sesion.setAttribute("listPass", "false");
...
//                request.getParameter("timeClass");
...
//            sesion.setAttribute("emty", "true");
            ...
            List<BangDiem> listBangDiemsPass = new ArrayList<BangDiem>();
            for (BangDiem listBangDiem : listBangDiems) {
                if (listBangDiem.getPoint().getDKDT() == 1) {
                    listBangDiemsPass.add(listBangDiem);
                    countDK ++;
                }
                else{
                    coutKDK ++;
