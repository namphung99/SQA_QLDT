 ...
 * @author DELL
 */
public class listBangDiemFalse extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        sesion.setAttribute("listFail", "false");
...
//        String nameSubject = request.getParameter("nameSub");
        ...
        String timeClass = (String) sesion.getAttribute("timeClass"); 
...
//            sesion.setAttribute("emty", "true");
            ...
            List<BangDiem> listBangDiemsFalse = new ArrayList<BangDiem>();
            for (BangDiem listBangDiem : listBangDiems) {
                if (listBangDiem.getPoint().getDKDT() == 0) {
                    listBangDiemsFalse.add(listBangDiem);
                    coutKDK++;
                }
                else{
                    countDK ++;
            ...
            if(listBangDiemsFalse.size() > 0){
                sesion.setAttribute("listFail", "true");
            }
            sapXep(listBangDiemsFalse);
            request.setAttribute("listBangDiems", listBangDiemsFalse);
